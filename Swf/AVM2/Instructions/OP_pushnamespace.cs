...
namespace Recurity.Swf.AVM2.Instructions
{
    ...
    /// 
    /// </summary>
	public class OP_pushnamespace : AbstractInstruction
	{
        /// <summary>
        /// 
        /// </summary>
        ...
        {
            if ( _Index >= abc.ConstantPool.Namespaces.Count )
            {
                throw new AbcVerifierException( "Namespace index out of bounds: " + _Index.ToString( "d" ) );
            }
        }
