...
namespace Recurity.Swf.AVM2.Instructions
{
    ...
    /// 
    /// </summary>
	public class OP_pushuint : AbstractInstruction
	{
        /// <summary>
        /// 
        /// </summary>
        ...
        {
            if ( _Index >= abc.ConstantPool.UIntegers.Count )
            {
                throw new AbcVerifierException( "UInt index out of bounds: " + _Index.ToString( "d" ) );
            }
        }
